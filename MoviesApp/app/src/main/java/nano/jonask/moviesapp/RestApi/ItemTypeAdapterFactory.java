 ...
 * <p/>
 * Source http://blog.robinchutaux.com/blog/a-smart-way-to-use-retrofit/
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
        ...
        return new TypeAdapter<T>() {
            ...
            public T read(JsonReader in) throws IOException {
                ...
                if (element.isJsonPrimitive() && element.toString().equals("\"\"")) { //error is thrown if string only consists of the string ("")
                    return null;
                }
